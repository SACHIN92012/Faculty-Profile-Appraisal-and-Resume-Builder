<?php
$code = 'DA';
$activity_type = 'Departmental Activities';
$field = 'Activity';
$url = 'Activities_DA.php';
...
if (Input::exists() && isset($_POST['upgrade_entry_x'])) {
  try {
    ...
    $stmt = "select * from faculty_profile_Activities where activityID='DA' and sno>$SNO and roll=$roll order by sno asc limit 1";
    // echo $stmt;
    $result = mysqli_query($conn, $stmt);
    $count = 0;
    $val = 0;
...
<body>
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          ...
                          <form action="Activities_DA.php" method="post">
  ...
  <script src="js/activities/Activities_DA.js"></script>
</body>
