...
if (Input::exists() && isset($_POST['csubmit'])) {
  ...
  try {
    ...
    $stmt = "INSERT INTO `faculty_profile_teaching` (`sno`, `name`, `roll`, `dept`, `subCode`, `ltp`, `numOfStudents`, `additionalInformation`, `semester`, `activityDate`, `lastUpdated`) VALUES (NULL, '$fname', '$roll', '$dept', '$subCode', '$ltp', $numOfStudents, '$additionalInformation', $semester, '$date',NULL)";
...
if (Input::exists() && isset($_POST['upgrade_entry_x'])) {
  ...
  try {
    ...
    $stmt = "select * from faculty_profile_teaching where sno>$SNO and roll=$roll order by sno asc limit 1";
    // echo $stmt;
    $result = mysqli_query($conn, $stmt);
    $count = 0;
    $val = 0;
    ...
    // echo $val;
    if ($count != 0) {
      $stmt = "update faculty_profile_teaching set sno=-1 where sno=$val";
      $result = mysqli_query($conn, $stmt);
      $stmt = "update faculty_profile_teaching set sno=$val where sno=$SNO";
      $result = mysqli_query($conn, $stmt);
      $stmt = "update faculty_profile_teaching set sno=$SNO where sno=-1";
      $result = mysqli_query($conn, $stmt);
    }
    // $result=mysqli_query($conn,$stmt);
  } catch (Exception $e) {
...
if (Input::exists() && isset($_POST['edit'])) {
  ...
  try {
    ...
    $prev_subCode = Input::get('prev_subCode');
    $prev_ltp = Input::get('prev_ltp');
    $prev_numOfStudents = Input::get('prev_numOfStudents');
    $prev_additionalInformation = Input::get('prev_additionalInformation');
    $prev_semester = Input::get('prev_semester');
    $prev_date = Input::get('prev_student_activity_date');
    ...
    $stmt = "Update `faculty_profile_teaching` set subCode='$subCode', ltp='$ltp' , numOfStudents=$numOfStudents ,additionalInformation='$additionalInformation',semester='$semester', activityDate = '$date' where subCode='$prev_subCode' and ltp='$prev_ltp' and roll='$roll' and numOfStudents=$prev_numOfStudents and activityDate = '$prev_date' and additionalInformation='$prev_additionalInformation' and semester=$prev_semester";
    // echo $subCode;
    // echo $ltp;
    // echo $numOfStudents;
    // echo $date;
...
<nav class="navbar navbar-expand-sm navbar-dark bg-dark p-2 fixed-top">
          ...
          <div class="row">
            ...
            <div class="col-md-12" style="width: 65rem;">
              ...
              ?>
                ...
                <div class="card">
                  <div class="card-header">
                    <h4><i class='fa fa-edit'></i>Edit Teaching</h4>
                  </div>
                  <br>
                  <form action="Teaching.php" method="post">
                    <input type='hidden' name='prev_subCode' value=<?php echo "'$subCode'" ?>>
                    <input type='hidden' name='prev_ltp' value=<?php echo "'$ltp'" ?>>
                    <input type='hidden' name='prev_numOfStudents' value=<?php echo "'$numOfStudents'" ?>>
                    <input type='hidden' name='prev_additionalInformation' value=<?php echo "'$additionalInformation'" ?>>
                    <input type='hidden' name='prev_semester' value=<?php echo "'$semester'" ?>>
                    <input type='hidden' name='prev_student_activity_date' value=<?php echo "'$date'" ?>>
                    <div class="form-group">
                      <label>Sub. Code<span class="m-1 text-primary">*</span></label>
                      <input type="text" value=<?php echo "'$subCode'" ?> class="form-control" name="subCode" id="subCode" placeholder="Place of visit" required>
                    </div>
                    <div class="form-group">
                      <label>L-T-P<span class="m-1 text-primary">*</span></label>
                      <input type="text" value=<?php echo "'$ltp'" ?> class="form-control" name="ltp" id="ltp" placeholder="L-T-P" required>
                    </div>
                    <div class="form-group">
                      <label>Number of Students<span class="m-1 text-primary">*</span></label>
                      <input type="number" value=<?php echo "'$numOfStudents'" ?> class="form-control" name="numOfStudents" placeholder="Number of Students" required>
                    </div>
                    <div class="form-group">
                      <label>Additional Information<span class="m-1 text-primary"></span></label>
                      <input type="text" value=<?php echo "'$additionalInformation'" ?> class="form-control" name="additionalInformation" placeholder="Additional Information">
                    </div>
                    <div class="form-group">
                      <label>Semester<span class="m-1 text-primary">*</span></label>
                      <input type="number" value=<?php echo "'$semester'" ?> class="form-control" name="semester" placeholder="Semester" required>
                    </div>
                    <div class="form-group">
                      <label for="student_activity_date">Activity Date:</label>
                      <input type="date" value=<?php echo "'$date'" ?> id="student_activity_date" name="student_activity_date">
                    </div>
              ...
              <?php
                ...
                <div class="card">
                  <div class="card-header">
                    <h4><i class="fa fa-plus"></i> Teaching</h4>
                  </div>
                  <br>
                  <form action="Teaching.php" method="post">
                    ...
                    <div class="form-group">
                      <label>Sub. Code<span class="m-1 text-primary">*</span></label>
                      <input type="text" class="form-control" name="subCode" id="subCode" placeholder="Place of visit" required>
                    </div>
                    <div class="form-group">
                      <label>L-T-P<span class="m-1 text-primary">*</span></label>
                      <input type="text" class="form-control" name="ltp" id="ltp" placeholder="L-T-P" required>
                    </div>
                    <div class="form-group">
                      <label>Number of Students<span class="m-1 text-primary">*</span></label>
                      <input type="number" class="form-control" name="numOfStudents" placeholder="Number of Students" required>
                    </div>
                    <div class="form-group">
                      <label>Additional Information<span class="m-1 text-primary"></span></label>
                      <input type="text" class="form-control" name="additionalInformation" placeholder="Additional Information">
                    </div>
                    <div class="form-group">
                      <label>Semester<span class="m-1 text-primary">*</span></label>
                    ...
                    <div class="form-group">
                      <label for="student_activity_date">Activity Date:</label>
                      <input type="date" id="student_activity_date" name="student_activity_date">
                    </div>
                ...
                <table class="table table-striped table-hover">
                  ...
                  <tbody>
                    ...
                    if (!$conn)
                      die("Unable to connect to database");
                    // echo $roll;
                    $stmt = "select * from faculty_profile_teaching where roll='$roll' order by sno desc;";
                    // echo $stmt;
                    $result = mysqli_query($conn, $stmt);
                    while ($row = mysqli_fetch_assoc($result)) {
                    ?>
                      <tr>
                        <td>
                          ...
                          <form action="Teaching.php" method="post">
                            <input type='hidden' name='subCode' value=<?php echo "'";
                                                                      echo $row['subCode'];
                                                                      echo "'"; ?>>
                            <input type='hidden' name='ltp' value=<?php echo "'";
                                                                  echo $row['ltp'];
                                                                  echo "'"; ?>>
                            <input type='hidden' name='numOfStudents' value=<?php echo "'";
                                                                            echo $row['numOfStudents'];
                                                                            echo "'"; ?>>
                            <input type='hidden' name='additionalInformation' value=<?php echo "'";
                                                                                    echo $row['additionalInformation'];
                                                                                    echo "'"; ?>>
                            <input type='hidden' name='semester' value=<?php echo "'";
                                                                        echo $row['semester'];
                                                                        echo "'"; ?>>
                            <input type='hidden' name='student_activity_date' value=<?php echo "'";
  ...
  <script src="js/teaching/teaching.js"></script>
</body>
