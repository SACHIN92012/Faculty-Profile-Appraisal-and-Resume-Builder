<?php
$code = 'SA';
$activity_type = 'Student Activities';
$field = 'Activity';
$url = 'Activities_SA.php';
...
if (Input::exists() && isset($_POST['upgrade_entry_x'])) {
  ...
  try {
    ...
    $stmt = "select * from faculty_profile_Activities where activityID='SA' and sno>$SNO and roll=$roll order by sno asc limit 1";
    // echo $stmt;
    $result = mysqli_query($conn, $stmt);
    $count = 0;
    $val = 0;
...
<head>
  <title>Student's Activities</title>
  <meta charset="utf-8">
...
<body>
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          ...
                          <form action="Activities_SA.php" method="post">
  ...
  <script src="js/activities/Activities_SA.js"></script>
</body>
