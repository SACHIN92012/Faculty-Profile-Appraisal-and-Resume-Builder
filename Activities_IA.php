<?php
$code = 'IA';
$activity_type = 'Institute Activities';
$field = 'Activity';
$url = 'Activities_IA.php';
...
if (Input::exists() && isset($_POST['upgrade_entry_x'])) {
  ...
  try {
    ...
    $stmt = "select * from faculty_profile_Activities where activityID='IA' and sno>$SNO and roll=$roll order by sno asc limit 1";
    // echo $stmt;
    $result = mysqli_query($conn, $stmt);
    $count = 0;
    $val = 0;
...
<body>
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          ...
                          <form action="Activities_IA.php" method="post">
  ...
  <script src="js/activities/Activities_IA.js"></script>
</body>
