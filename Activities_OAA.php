<?php
$code = 'OAA';
$activity_type = 'Other Academic Activities';
$field = 'Activity';
$url = 'Activities_OAA.php';
...
if (Input::exists() && isset($_POST['upgrade_entry_x'])) {
  ...
  try {
    ...
    $stmt = "select * from faculty_profile_Activities where activityID='OAA' and sno>$SNO and roll=$roll order by sno asc limit 1";
    // echo $stmt;
    $result = mysqli_query($conn, $stmt);
    $count = 0;
    $val = 0;
...
<head>
  <title>Other Academic Activities</title>
  <meta charset="utf-8">
...
<body>
  ...
  <script src="js/activities/Activities_OAA.js"></script>
</body>
