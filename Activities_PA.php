<?php
$code = 'PA';
$activity_type = 'Professional Activities';
$field = 'Activity';
$url = 'Activities_PA.php';
...
if (Input::exists() && isset($_POST['upgrade_entry_x'])) {
  ...
  try {
    ...
    $stmt = "select * from faculty_profile_Activities where activityID='PA' and sno>$SNO and roll=$roll order by sno asc limit 1";
    // echo $stmt;
    $result = mysqli_query($conn, $stmt);
    $count = 0;
    $val = 0;
...
<body>
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          ...
                          <form action="Activities_PA.php" method="post">
  ...
  <script src="js/activities/Activities_PA.js"></script>
</body>
