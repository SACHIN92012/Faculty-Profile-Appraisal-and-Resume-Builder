...
if (Input::exists() && isset($_POST['csubmit'])) {
  ...
  try {
    ...
    $nameOfJournel = Input::get('nameOfJournel');
    $nameOfPublisher = Input::get('nameOfPublisher');
    $positionHeld = Input::get('positionHeld');
    $year = Input::get('year');
    ...
    $stmt = "INSERT INTO `faculty_profile_honours_mebj` (`sno`, `name`, `roll`, `dept`, `nameOfJournel`,`nameOfPublisher`,`positionHeld`,`year`, `activityDate`, `lastUpdated`) VALUES (NULL, '$fname', '$roll', '$dept', '$nameOfJournel','$nameOfPublisher','$positionHeld', $year, '$activityDate',NULL)";
    // echo $stmt;
...
if (Input::exists() && isset($_POST['delete_entry'])) {
  ...
  try {
    ...
    // $stmt="insert into discussion values('$email','$dateTime','$club_id','$text');";
    $stmt = "Delete from `faculty_profile_honours_mebj` where positionHeld='$positionHeld' and nameOfPublisher='$nameOfPublisher' and nameOfJournel='$nameOfJournel' and year=$year and roll='$roll' and activityDate = '$activityDate'";
    $result = mysqli_query($conn, $stmt);
    // echo $stmt;
  } catch (Exception $e) {
    die($e->getMessage());
...
if (Input::exists() && isset($_POST['upgrade_entry_x'])) {
  ...
  try {
    ...
    $stmt = "select * from faculty_profile_honours_mebj where sno>$SNO and roll=$roll order by sno asc limit 1";
    // echo $stmt;
    $result = mysqli_query($conn, $stmt);
    $count = 0;
    $val = 0;
    ...
    // echo $val;
    if ($count != 0) {
      $stmt = "update faculty_profile_honours_mebj set sno=-1 where sno=$val";
      $result = mysqli_query($conn, $stmt);
      $stmt = "update faculty_profile_honours_mebj set sno=$val where sno=$SNO";
      $result = mysqli_query($conn, $stmt);
      $stmt = "update faculty_profile_honours_mebj set sno=$SNO where sno=-1";
      $result = mysqli_query($conn, $stmt);
    }
    // $result=mysqli_query($conn,$stmt);
  } catch (Exception $e) {
...
if (Input::exists() && isset($_POST['edit'])) {
  ...
  try {
    ...
    // $stmt="insert into discussion values('$email','$dateTime','$club_id','$text');";
    $stmt = "Update `faculty_profile_honours_mebj` set positionHeld='$positionHeld', nameOfPublisher='$nameOfPublisher', nameOfJournel='$nameOfJournel', year=$year, activityDate='$activityDate' where nameOfPublisher='$prev_membershipStatus' and nameOfJournel='$prev_nameOfTheBody' and year=$prev_yearAwarded and roll='$roll' and activityDate = '$prev_activityDate' and positionHeld='$prev_positionHeld'";
...
<!-- MAIN BODY - SIDEBAR ends -->
            ...
            <div class="col-md-12" style="width: 65rem;">
              ...
              ?>
                ...
                <div class="card">
                  ...
                  <br>
                  <form action="Honours_MEBJ.php" method="post">
                    <input type='hidden' name='prev_nameOfTheBody' value=<?php echo "'$nameOfJournel'" ?>>
                    <input type='hidden' name='prev_membershipStatus' value=<?php echo "'$nameOfPublisher'" ?>>
                    <input type='hidden' name='prev_positionHeld' value=<?php echo "'$positionHeld'" ?>>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" value=<?php echo "'$nameOfJournel'" ?> class="form-control" name="nameOfJournel" id="nameOfJournel"  placeholder="Name of Journal" required>
                    </div>
                    <div class="form-group">
                      <label>Name of Publisher<span class="m-1 text-primary">*</span></label>
                      <input type="text" value=<?php echo "'$nameOfPublisher'" ?> class="form-control" name="nameOfPublisher" id="nameOfPublisher"  placeholder="Name of Publisher" required>
                    </div>
                    <div class="form-group">
                      <label>Position Held<span class="m-1 text-primary">*</span></label>
                      <input type="text" value=<?php echo "'$positionHeld'" ?> class="form-control" name="positionHeld" id="positionHeld"  placeholder="Position Held" required>
                    </div>
                    <div class="form-group">
              ...
              <?php
                ...
                <div class="card">
                  <div class="card-header">
                    <h4><i class="fa fa-plus"></i> Member, Editorial Board of Journal</h4>
                  </div>
                  <br>
                  <form action="Honours_MEBJ.php" method="post">
                    ...
                    <div class="form-group">
                      <label>Name of Journal<span class="m-1 text-primary">*</span></label>
                      <input type="text" class="form-control" name="nameOfJournel"  id="nameOfJournel" placeholder="Name of Journal" required>
                    </div>
                    <div class="form-group">
                      <label>Name of Publisher<span class="m-1 text-primary">*</span></label>
                      <input type="text" class="form-control" name="nameOfPublisher"  id="nameOfPublisher" placeholder="Name of Publisher" required>
                    </div>
                    <div class="form-group">
                      <label>Position Held<span class="m-1 text-primary">*</span></label>
                      <input type="text" class="form-control" name="positionHeld"  id="positionHeld" placeholder="Position Held" required>
                    </div>
                    <div class="form-group">
                      <label>Year<span class="m-1 text-primary">*</span></label>
                ...
                <table class="table table-striped table-hover">
                  ...
                  <tbody>
                    ...
                    if (!$conn)
                      die("Unable to connect to database");
                    // echo $roll;
                    $stmt = "select * from faculty_profile_honours_mebj where roll='$roll' order by sno desc;";
                    // echo $stmt;
                    $result = mysqli_query($conn, $stmt);
                    while ($row = mysqli_fetch_assoc($result)) {
                    ?>
                      <tr>
                        <td>
                          ...
                          <form action="Honours_MEBJ.php" method="post">
                            <input type='hidden' name='nameOfJournel' value=<?php echo "'";
                                                                            echo $row['nameOfJournel'];
                                                                            echo "'"; ?>>
                            <input type='hidden' name='nameOfPublisher' value=<?php echo "'";
                                                                              echo $row['nameOfPublisher'];
                                                                              echo "'"; ?>>
                            <input type='hidden' name='positionHeld' value=<?php echo "'";
                                                                            echo $row['positionHeld'];
                                                                            echo "'"; ?>>
                        ...
                        <td><?php echo $row['nameOfJournel'] ?></td>
                        <td><?php echo $row['nameOfPublisher'] ?></td>
                        <td><?php echo $row['positionHeld'] ?></td>
  ...
  <script src="js/honours/Honours_MEBJ.js"></script>
</body>
