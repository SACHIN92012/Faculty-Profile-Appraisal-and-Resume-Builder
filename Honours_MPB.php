...
if (Input::exists() && isset($_POST['csubmit'])) {
  ...
  try {
    ...
    $nameOfTheBody = Input::get('nameOfTheBody');
    $membershipStatus = Input::get('membershipStatus');
    $yearAwarded = Input::get('yearAwarded');
    ...
    $stmt = "INSERT INTO `faculty_profile_honours_mpb` (`sno`, `name`, `roll`, `dept`, `nameOfTheBody`,`membershipStatus`,`yearAwarded`, `activityDate`, `lastUpdated`) VALUES (NULL, '$fname', '$roll', '$dept', '$nameOfTheBody','$membershipStatus', $yearAwarded, '$activityDate',NULL)";
    // echo $stmt;
...
if (Input::exists() && isset($_POST['delete_entry'])) {
  ...
  try {
    ...
    // $stmt="insert into discussion values('$email','$dateTime','$club_id','$text');";
    $stmt = "Delete from `faculty_profile_honours_mpb` where membershipStatus='$membershipStatus' and nameOfTheBody='$nameOfTheBody' and yearAwarded=$yearAwarded and roll='$roll' and activityDate = '$activityDate'";
    $result = mysqli_query($conn, $stmt);
    // echo $stmt;
  } catch (Exception $e) {
    die($e->getMessage());
...
if (Input::exists() && isset($_POST['upgrade_entry_x'])) {
  ...
  try {
    ...
    $stmt = "select * from faculty_profile_honours_mpb where sno>$SNO and roll=$roll order by sno asc limit 1";
    // echo $stmt;
    $result = mysqli_query($conn, $stmt);
    $count = 0;
    $val = 0;
    ...
    // echo $val;
    if ($count != 0) {
      $stmt = "update faculty_profile_honours_mpb set sno=-1 where sno=$val";
      $result = mysqli_query($conn, $stmt);
      $stmt = "update faculty_profile_honours_mpb set sno=$val where sno=$SNO";
      $result = mysqli_query($conn, $stmt);
      $stmt = "update faculty_profile_honours_mpb set sno=$SNO where sno=-1";
      $result = mysqli_query($conn, $stmt);
    }
    // $result=mysqli_query($conn,$stmt);
  } catch (Exception $e) {
...
if (Input::exists() && isset($_POST['edit'])) {
  ...
  try {
    ...
    // $stmt="insert into discussion values('$email','$dateTime','$club_id','$text');";
    $stmt = "Update `faculty_profile_honours_mpb` set membershipStatus='$membershipStatus', nameOfTheBody='$nameOfTheBody', yearAwarded=$yearAwarded, activityDate='$activityDate' where membershipStatus='$prev_membershipStatus' and nameOfTheBody='$prev_nameOfTheBody' and yearAwarded=$prev_yearAwarded and roll='$roll' and activityDate = '$prev_activityDate'";
...
<head>
  <title>Professional Body Member</title>
  <meta charset="utf-8">
...
<body>
            ...
            <div class="col-md-12" style="width: 65rem;">
              ...
              ?>
                ...
                <div class="card">
                  ...
                  <br>
                  <form action="Honours_MPB.php" method="post">
                    <input type='hidden' name='prev_nameOfTheBody' value=<?php echo "'$nameOfTheBody'" ?>>
                    <input type='hidden' name='prev_membershipStatus' value=<?php echo "'$membershipStatus'" ?>>
                    <input type='hidden' name='prev_yearAwarded' value=<?php echo "'$yearAwarded'" ?>>
                    <input type='hidden' name='prev_activityDate' value=<?php echo "'$activityDate'" ?>>
                    <div class="form-group">
                      <label>Name of the Body<span class="m-1 text-primary">*</span></label>
                      <input type="text" value=<?php echo "'$nameOfTheBody'" ?> class="form-control" name="nameOfTheBody" id="nameOfTheBody" placeholder="Name of the Body" required>
                    </div>
                    <div class="form-group">
                      <label>Membership Status<span class="m-1 text-primary">*</span></label>
                      <input type="text" value=<?php echo "'$membershipStatus'" ?> class="form-control" name="membershipStatus" id="membershipStatus" placeholder="Membership Status" required>
                    </div>
                    <div class="form-group">
                      <label>Year Awarded<span class="m-1 text-primary">*</span></label>
                      <input type="number" value=<?php echo "'$yearAwarded'" ?> class="form-control" name="yearAwarded" placeholder="Year Awarded" required>
                    </div>
                    <div class="form-group">
              ...
              <?php
                ...
                <div class="card">
                  <div class="card-header">
                    <h4><i class="fa fa-plus"></i> Member - Professional Body</h4>
                  </div>
                  <br>
                  <form action="Honours_MPB.php" method="post">
                    ...
                    <div class="form-group">
                      <label>Name of the Body<span class="m-1 text-primary">*</span></label>
                      <input type="text" class="form-control" name="nameOfTheBody" id="nameOfTheBody"  placeholder="Name of the Body" required>
                    </div>
                    <div class="form-group">
                      <label>Membership Status<span class="m-1 text-primary">*</span></label>
                      <input type="text" class="form-control" name="membershipStatus" id="membershipStatus" placeholder="Membership Status" required>
                    </div>
                    <div class="form-group">
                      <label>Year Awarded<span class="m-1 text-primary">*</span></label>
                      <input type="number" class="form-control" name="yearAwarded" placeholder="Year Awarded" required>
                    </div>
                    <div class="form-group">
                      <label for="student_activity_date">Activity Date:</label>
                ...
                <table class="table table-striped table-hover">
                  ...
                  <tbody>
                    ...
                    if (!$conn)
                      die("Unable to connect to database");
                    // echo $roll;
                    $stmt = "select * from faculty_profile_honours_mpb where roll='$roll' order by sno desc;";
                    // echo $stmt;
                    $result = mysqli_query($conn, $stmt);
                    while ($row = mysqli_fetch_assoc($result)) {
                    ?>
                      <tr>
                        <td>
                          ...
                          <form action="Honours_MPB.php" method="post">
                            <input type='hidden' name='nameOfTheBody' value=<?php echo "'";
                                                                            echo $row['nameOfTheBody'];
                                                                            echo "'"; ?>>
                            <input type='hidden' name='membershipStatus' value=<?php echo "'";
                                                                                echo $row['membershipStatus'];
                                                                                echo "'"; ?>>
                            <input type='hidden' name='yearAwarded' value=<?php echo "'";
                                                                          echo $row['yearAwarded'];
                                                                          echo "'"; ?>>
                        ...
                        <td><?php echo $row['nameOfTheBody'] ?></td>
                        <td><?php echo $row['membershipStatus'] ?></td>
  ...
  <script src="js/honours/Honours_MPB.js"></script>
</body>
